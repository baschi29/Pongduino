...
Controller::Controller(int fieldXDim, int fieldYDim, int paddleWidth, int paddleLength, int ballSize, int speakerPin, int leftDSTriggerPin, int leftDSEchoPin, int rightDSTriggerPin, int rightDSEchoPin) : 
    ...
    _leftPaddle(1, (float)(fieldYDim / 2 - 1) - (paddleLength - 1) / 2, paddleWidth, paddleLength, fieldYDim - 2 - paddleLength, 1, fieldYDim, 20, 3),
    _rightPaddle((float)fieldXDim - 2 - paddleWidth, (float)(fieldYDim / 2 - 1) - (paddleLength - 1) / 2, paddleWidth, paddleLength, fieldYDim - 2 - paddleLength, 1, fieldYDim, 20, 3),
